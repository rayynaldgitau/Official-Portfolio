...
export default function App() {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={() => setView('portfolio')}
        className="fixed bottom-8 left-8 px-4 py-2 rounded-full bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white text-sm font-medium z-50 transition-all hover:scale-105"
      >
        ← Back to Portfolio
      </button>
    </div>
