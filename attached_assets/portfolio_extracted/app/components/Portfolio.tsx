...
const projects = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1763771787035-99c6c28ec78e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw1fHxzZXJ2ZXIlMjBpbmZyYXN0cnVjdHVyZSUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdHxlbnwxfHx8fDE3Nzc3MzA2OTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1659782229445-19a69f10f6d8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZXZvcHMlMjB0ZWNobm9sb2d5JTIwbmV0d29ya3xlbnwxfHx8fDE3Nzc3MzA2OTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1639066648921-82d4500abf1a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxzZXJ2ZXIlMjBpbmZyYXN0cnVjdHVyZSUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdHxlbnwxfHx8fDE3Nzc3MzA2OTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1561233835-f937539b95b9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZXJ2ZXIlMjBpbmZyYXN0cnVjdHVyZSUyMHRlY2hub2xvZ3klMjBhYnN0cmFjdHxlbnwxfHx8fDE3Nzc3MzA2OTh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              ...
              <Button size="lg" variant="outline" className="border-slate-700 hover:border-cyan-400">
                View Projects
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tags.map((tag) => (
                          <Badge key={tag} variant="outline" className="border-cyan-400/30 text-cyan-400">
                            {tag}
                          </Badge>
                        ))}
                      </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 w-full sm:w-auto">
                <Mail className="w-5 h-5 mr-2" />
                raynald.gitau@example.com
              </Button>
              <Button size="lg" variant="outline" className="border-slate-700 hover:border-cyan-400 w-full sm:w-auto">
      ...
      <footer className="border-t border-slate-800 py-8">
        <div className="max-w-7xl mx-auto px-6 text-center text-slate-400">
          <p className="text-sm">
            © 2026 Raynald Gitau. Built with React, Tailwind CSS, and Motion.
          </p>
        </div>
      </footer>
    </div>
